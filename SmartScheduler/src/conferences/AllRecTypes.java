...
public class AllRecTypes {
	
	  private WebDriver driver;
	  private String baseUrl;
	  
	  
	  public static Logger logger = Logger.getLogger(AllRecTypes.class);
  ...
  public void daily() throws InterruptedException {
	try{
	  ...
	  //edit title
		 ...
		 Thread.sleep(1000);
		 driver.findElement(By.xpath("//*[@id='title']")).sendKeys("daily rec meeting");
	 ...
	 // driver.findElement(By.xpath("//div[6]/div[1]/table/tbody/tr[3]/td[1]")).click();
	    ...
	    logger.info("Created daily rec meeting");
	    Thread.sleep(1000);
	...
	//    driver.findElement(By.linkText("Open Smart Scheduler")).click();
	    ...
	    Thread.sleep(1000);
	    logger.info("Deleted daily rec meeting");
  ...
  public void weekly() throws InterruptedException {
		try{
		  ...
		  //edit title
			 ...
			 driver.findElement(By.xpath("//*[@id='title']")).clear();
			 Thread.sleep(1000);
			 driver.findElement(By.xpath("//*[@id='title']")).sendKeys("weekly rec meeting");
		    ...
		    driver.findElement(By.xpath("//*[@id='SchedEdit-RecurrenceCollapse']/div/div/div[2]/div[2]/div[1]/div/button")).click();  
		    Thread.sleep(1000);
		    driver.findElement(By.xpath(".//*[@id='SchedEdit-RecurrenceCollapse']/div/div/div[2]/div[2]/div[1]/div/div/ul/li[4]/a/span")).click();
		    Thread.sleep(1000);
		    driver.findElement(By.xpath("//*[@id='SchedEdit-RecurrenceCollapse']/div/div/div[2]/div[2]/div[2]/div/button")).click();
		    Thread.sleep(1000);
	...
	//	    driver.findElement(By.xpath(" html/body/div[6]/div[1]/table/tbody/tr[6]/td[4]")).click();
		    ...
		    //click save button
		    driver.findElement(By.xpath("html/body/div[3]/div/div/div[3]/div/button[1]")).click();	    
		    logger.info("Created weekly rec meeting");
		    Thread.sleep(1000);
		    ...
		    driver.findElement(By.xpath("html/body/div[3]/div/div/div[3]/div/div/div[2]/div/div/div[1]/button")).click();
		    Thread.sleep(1000);
		    logger.info("Deleted weekly rec meeting");
  ...
  public void monthly() throws InterruptedException {
		try{
		  ...
		  //edit title
			 ...
			 driver.findElement(By.xpath("//*[@id='title']")).clear();
			 Thread.sleep(1000);
			 driver.findElement(By.xpath("//*[@id='title']")).sendKeys("monthly rec meeting");
	...
	//	    driver.findElement(By.xpath(" html/body/div[6]/div[1]/table/tbody/tr[6]/td[4]")).click();
		    ...
		    //click save button
		    driver.findElement(By.xpath("html/body/div[3]/div/div/div[3]/div/button[1]")).click();	    
		    logger.info("Created monthly rec meeting");
		    Thread.sleep(1000);
		    ...
		    driver.findElement(By.xpath("html/body/div[3]/div/div/div[3]/div/div/div[2]/div/div/div[1]/button")).click();
		    Thread.sleep(1000);
		    logger.info("Deleted monthly rec meeting");
